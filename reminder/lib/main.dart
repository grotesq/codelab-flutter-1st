...
class TodoListState extends State<TodoList> {
  ...
  void initState() {
    ...
    String data = storage.getItem('todo-list');
    if( data == null ) {
      list = [];
    }
    else {
    ...
    dev.log( data.toString(), name: 'todo log' );
    dev.log( list.toString(), name: 'todo log' );
  }
                  ...
                  RaisedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        storage.setItem('todo-list', jsonEncode(list));
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        setState(() {
                          list.removeAt( index );
                          storage.setItem('todo-list', list);
                        });
                      },
                      child: Icon(
                          Icons.check
